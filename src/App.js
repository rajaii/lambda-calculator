...
////clean out comments and figure out how to map with index to set to key for specials numbers and operators buttoncomponents
//finnish display components display and style then done